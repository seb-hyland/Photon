...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (sumiInk-4		"#696991" "#303030")
  (sumiInk-5		"#b3b3e6" "#303030")
  (sumiInk-6		"#a0a0ae" "#303030")

  (waveBlue-1		"#294a78" "#4e4e4e")
  (waveBlue-2		"#546e94" "#585858")
 ...
 (
  ...
  (header-line                                   (:background sumiInk-1 :overline fujiGray))
  (header-line-inactive                          (:background sumiInk-1 :weight 'medium :overline fujiGray))
  ...
  (mode-line                                     (:background sumiInk-1 :color sumiInk-2))
  (mode-line-inactive                            (:background sumiInk-1 :foreground fujiGray :box (:line-width 6 :color sumiInk-1) :weight 'extra-light :overline fujiGray))
  (mode-line-active                              (:background sumiInk-1 :foreground fujiWhite :box (:line-width 6 :color sumiInk-1) :overline fujiWhite))
