...
(autothemer-deftheme
	...
	(fringe                                        (:foreground sumiInk-1b))
	(glyph-face                                    (:background sumiInk-4))
	(glyphless-char                                (:foreground sumiInk-4))
	(header-line                                   (:background sumiInk-1b :overline fujiGrey))
	(header-line-inactive                          (:background sumiInk-1b :weight 'medium :overline fujiGrey))
	...
	(fill-column-indicator                         (:foreground comet))
	...
	(vi-tilde-fringe-face                          (:foreground crystalBlue))

	;; Font lock
	(font-lock-keyword-face                        (:foreground oniViolet :weight 'semi-bold :slant 'italic))
	(font-lock-type-face                           (:foreground carpYellow))
	(font-lock-property-use-face                   (:foreground peachRed)) ;; Fields
	(font-lock-warning-face                        (:foreground roninYellow))
	(font-lock-string-face                         (:foreground springGreen :italic t))
	(font-lock-builtin-face                        (:foreground sakuraPink))
	(font-lock-reference-face                      (:foreground peachRed))
	(font-lock-constant-face                       (:foreground carpYellow))
	(font-lock-function-name-face                  (:foreground springViolet2))
	(font-lock-function-call-face                  (:foreground springViolet2))
	(font-lock-variable-name-face                  (:foreground fujiWhite))
	(font-lock-negation-char-face                  (:foreground peachRed))
	(font-lock-comment-face                        (:foreground comet :background sumiInk-2 :italic t))
	(font-lock-comment-delimiter-face              (:inherit 'font-lock-comment-face))
	(font-lock-doc-face                            (:inherit 'font-lock-comment-face))
	(font-lock-doc-markup-face                     (:inherit 'font-lock-comment-face))
	(font-lock-preprocessor-face	               (:foreground sakuraPink))
	(font-lock-regexp-grouping-backslash           (:foreground boatYellow2))
	(font-lock-number-face                         (:foreground carpYellow))
	(font-lock-operator-face                       (:foreground carpYellow))
	(font-lock-punctuation-face                    (:foreground fujiWhite))
	...
	(flymake-warning                               (:underline (:color carpYellow :style 'wave)))
	(flymake-error                                 (:underline (:color peachRed :style 'wave)))
	(flymake-note                                  (:underline (:color waveAqua2 :style 'wave)))
	...
	(eldoc-highlight-function-argument             (:foreground sumiInk-1 :background crystalBlue :bold t))
	...
	;; term
	(term                                          (:background sumiInk-1b :foreground fujiWhite))
	...
	(completions-common-part                       (:foreground oniViolet))
	(child-frame-border                            (:foreground sumiInk-2))
	(eldoc-box-border                              (:background sumiInk-2))
	(eldoc-box-body                                (:background sumiInk-2))

	(corfu-current                                 (:background sumiInk-1b :weight 'bold))
	(corfu-default                                 (:background sumiInk-2 :foreground fujiWhite))
	(corfu-border                                  (:background sumiInk-2))
	(corfu-popupinfo                               (:background sumiInk-2))
