...
(autothemer-deftheme
 photon-light "A modified version of Kanagawa, a theme inspired by the colors of the famous painting by Katsushika Hokusa"
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (sumiInk-0		"#FFEBC4" "#ffffff")
  (sumiInk-1b		"#F7E7C6" "#ffffff")
  (sumiInk-1		"#FFFCDE" "#ffffff")
  (sumiInk-2		"#F0E3D5" "#C99169")
  (sumiInk-3		"#C99169" "#303030")
  (sumiInk-4		"#CCAB93" "#303030")
  (sumiInk-5		"#522202" "#303030")
  (sumiInk-6		"#191921" "#303030")

  (waveBlue-1		"#223249" "#4e4e4e")
  (waveBlue-2		"#2D4F67" "#585858")
  (waveAqua1		"#6A9589" "#6a9589")
  (waveAqua2		"#72B8AA" "#717C7C")
  
  (samuraiRed       "#E82438" "#585858")

  (winterGreen		"#253D1C" "#585858")
  (winterYellow		"#4F4028" "#585858")
  (winterRed		"#2E1A1E" "#585858")
  (winterBlue		"#1F1F29" "#585858")

  (autumnGreen		"#76946A" "#585858")
  (autumnRed		"#DE2C2F" "#585858")
  (autumnYellow		"#DCA561" "#585858")

  (roninYellow		"#FF9E3B" "#585858")

  (dragonBlue		"#9DC2D4" "#658594")
  (fujiGray         "#727169" "#717C7C")
  (springViolet1	"#8B7DAD" "#717C7C")
  (oniViolet		"#9271C7" "#717C7C")
  (crystalBlue		"#484DDB" "#717C7C")
  (springViolet2	"#8FA8D9" "#717C7C")
  (springBlue		"#6CBDE0" "#717C7C")
  (springGreen		"#86C462" "#717C7C")
  (boatYellow1		"#938056" "#717C7C")
  (boatYellow2		"#DBB163" "#717C7C")
  (carpYellow		"#FCD283" "#717C7C")
  (sakuraPink		"#FC588C" "#717C7C")
  (waveRed          "#E85D6D" "#717C7C")
  (peachRed         "#FF5E6E" "#717C7C")
  (surimiOrange		"#FF8E59" "#717C7C")
 ...
 (
  ...
  (org-meta-line                                 (:background springGreen :foreground winterGreen))
  (org-block                                     (:background sumiInk-0 :foreground sumiInk-6))
  (org-block-begin-line                          (:background sumiInk-1b :foreground waveBlue-2))
  (org-block-end-line	                         (:background sumiInk-1b :foreground waveBlue-2))
 ...
 ;; Tree sitter highlightning
  ...
  (transient-key-exit (:foreground waveRed :background nil :bold t))
